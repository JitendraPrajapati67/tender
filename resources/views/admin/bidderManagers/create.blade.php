...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.bidderManager.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bidder-managers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_reg_number') ? 'is-invalid' : '' }}" type="text" name="company_reg_number" id="company_reg_number" value="{{ old('company_reg_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_contact_person') ? 'is-invalid' : '' }}" type="text" name="company_contact_person" id="company_contact_person" value="{{ old('company_contact_person', '') }}" required>
